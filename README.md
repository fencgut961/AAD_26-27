...
Este repositorio organiza el trabajo del módulo siguiendo los **Resultados de Aprendizaje (RA)** establecidos en el currículo oficial. Cada resultado de aprendizaje se desarrolla en una rama independiente, facilitando el seguimiento de las actividades, la evaluación continua y la evolución de las soluciones implementadas.

---

## Resultados de Aprendizaje y Criterios de Evaluación

### [RA1. Desarrolla aplicaciones que gestionan información almacenada en ficheros identificando el campo de aplicación de los mismos y utilizando clases específicas.](https://github.com/fencgut961/AAD_26-27/blob/main/RA1/ra1-manejo-ficheros.md)
